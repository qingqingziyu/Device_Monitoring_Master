...
public class BaseFragment extends Fragment implements ISupportFragment,ILoad {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ContextHolder.initial(getActivity());
    ...
    protected void showLoadingDialog(String msg) {
        if (loadingDialog == null) {
            loadingDialog = LoadingShowDialog.createDialog(getActivity());
